...
export async function createPlaylist(name) {
  try {
    const response = await backendFetch(`/api/userPlaylists`, {
      method: "POST",
      headers: {
...
export async function addSongToPlaylist(playlistID, song) {
  try {
    const response = await backendFetch(`/api/userPlaylists/songs`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function getSinglePlaylist(id) {
  try {
    const response = await backendFetch(`/api/userPlaylists/songs?playlist=${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
