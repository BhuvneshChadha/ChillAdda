...
const page = () => {
  return (
    <div className='w-11/12 mt-20 mx-auto text-white min-h-screen'>
        ...
        <h2 className='mt-4 text-xl font-bold'>ChillAdda.live does not store any files on our server, we only linked to the media which is hosted on 3rd party services.</h2>
    </div>
  )
}
